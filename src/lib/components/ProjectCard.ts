...
export default function ProjectCard(
    ...
    const ui = useTSElements(
        ...
        <a class="group relative overflow-hidden shadow-lg block" id="card-${dataId}" href=${project.url}>
            ...
            <!-- Overlay Content -->
            <div
                class="absolute inset-0 bg-black/70 flex flex-col justify-center items-center text-white opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out pointer-events-none group-hover:pointer-events-auto">
